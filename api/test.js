...
const prompt = `You are a Vietnamese nutritionist. Create a 1-day meal plan.

REQUIREMENTS:
- Target: ~2000 kcal/day (distribute: breakfast ~25%, lunch ~40%, dinner ~35%)
- Diet type: "Cân bằng" — Ăn uống đa dạng, đầy đủ các nhóm chất dinh dưỡng.
...
generateContent(prompt, true).then(res => console.log('RESULT:', JSON.stringify(res))).catch(err => console.error('ERROR:', err));
