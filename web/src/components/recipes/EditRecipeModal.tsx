...
export default function EditRecipeModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center px-4 py-8" style={{ animation: 'fadeIn 200ms ease-out' }}>
      ...
      <div className="relative bg-white dark:bg-slate-800 rounded-2xl w-full max-w-xl max-h-[85vh] flex flex-col my-4 overflow-hidden shadow-2xl" style={{ animation: 'slideUp 250ms ease-out' }}>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-black dark:text-white rounded-xl focus:outline-none focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 transition-all"
                  >
