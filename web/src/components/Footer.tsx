...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-slate-900 text-gray-600 dark:text-gray-400 border-t border-gray-200 dark:border-slate-800 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <div className="bg-black dark:bg-white p-2 rounded-full"><ChefHat className="h-6 w-6 text-white dark:text-black" /></div>
              <span className="text-xl font-bold text-gray-900 dark:text-white">CookingBoy</span>
            </div>
            <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">Khám phá thế giới ẩm thực với những công thức nấu ăn đa dạng, từ món truyền thống đến hiện đại, giúp bạn tạo ra những bữa ăn ngon miệng.</p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-200 dark:border-slate-800 mt-8 pt-8 text-center">
          <p className="text-gray-500 dark:text-gray-400 text-sm">&copy; {new Date().getFullYear()} CookingWeb</p>
        </div>
      </div>
    </footer>
  );
