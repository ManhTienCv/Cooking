...
--   pgAdmin: click database "CookingDB" in tree â†’ right-click â†’ Query Tool â†’ paste â†’ Execute.
...
-- If the role was created unquoted, it may be lowercase cooking â€” change below.
